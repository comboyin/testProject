...
-- Dumping data for table minh_nhut_lession_3.friend_relation: ~4 rows (approximately)
...
-- Dumping data for table minh_nhut_lession_3.friend_request: ~7 rows (approximately)
/*!40000 ALTER TABLE `friend_request` DISABLE KEYS */;
INSERT INTO `friend_request` (`id`, `user_id`, `user_id_to`, `regist_datetime`) VALUES
	(13, 1, 5, '2015-10-29 10:22:20');
...
-- Dumping data for table minh_nhut_lession_3.like: ~11 rows (approximately)
/*!40000 ALTER TABLE `like` DISABLE KEYS */;
INSERT INTO `like` (`id`, `user_id`, `pictures_id`) VALUES
	(63, 6, 121),
	(64, 6, 122),
	(65, 6, 123),
	(66, 6, 124),
...
INSERT INTO `picture` (`id`, `url`, `view`, `like_number`, `regist_datetime`, `user_id`) VALUES
	...
	(92, '20150609154933_ZaSEynrddh5629b984b51d0.jpg', 1, 0, '2015-10-23 11:37:24', 1),
	(96, '20150926131009_wPpZsOz1Hd5629ba408ca07.jpg', 1, 0, '2015-10-23 11:40:32', 1),
	...
	(138, 'hinh-khoi-my-15562f444e7ed28.jpg', 0, 0, '2015-10-27 04:30:54', 5),
...
INSERT INTO `user` (`id`, `username`, `password`, `fullname`, `sex`, `birthday`, `address`, `introduction`, `avatar`, `email`, `group_id`) VALUES
	...
	(5, 'khoimy', 'e10adc3949ba59abbe56e057f20f883e', 'Khởi my', 0, '1992-10-26', 'Ở đâu', 'ádasdasdasdasda', 'Untitled562efd221261e.png', 'đâsdasđ@gmail.com', 2),
	...
	(7, 'hoailinh', 'e10adc3949ba59abbe56e057f20f883e', 'hoài linh', 1, '2015-10-27', 'miền tây', 'sfasfsdf sdafsd', 'sdfasdf a.jpg', 'hoailinh@gmail.com', 2),
